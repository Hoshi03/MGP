...
public class PuzzleActivityN1 extends AppCompatActivity {
// 2-1 스테이지

    ImageButton[] blanks = new ImageButton[2];
    ImageButton[] quizzes = new ImageButton[6];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_puzzle6s);
        // 상태바 및 내비게이션 바 숨기기
        ...
        quizzes[0] = findViewById(R.id.stage6_quiz1);
        quizzes[1] = findViewById(R.id.stage6_quiz2);
        quizzes[2] = findViewById(R.id.stage6_quiz3);
        quizzes[3] = findViewById(R.id.stage6_quiz4);
        quizzes[4] = findViewById(R.id.stage6_quiz5);
        quizzes[5] = findViewById(R.id.stage6_quiz6);
        ...
        for (int i = 0; i < quizzes.length; i++) { //낱말 수만큼 반복
            ...
            quizzes[i].setOnClickListener(new View.OnClickListener() {  //각 낱말들 마다 이벤트 리스너 등록
                ...
                public void onClick(View v) {
                    ...
                    if(answer.equals("움츠")) {
                        Intent intent = new Intent(PuzzleActivityN1.this, PuzzleActivityN2.class);
...
//                    Toast.makeText(PuzzleActivity.this, answer, Toast.LENGTH_SHORT).show();
    ...
    private int getResourceIdFromButton(ImageButton button) { //눌린 버튼의 낱말을 정답 문자열에 추가 + 문장 빈칸에 띄우기
        int id = button.getId();
        if (id == R.id.stage6_quiz1) {
            answer += "움";
            return R.drawable.stage6_answer1;
        }
        else if (id == R.id.stage6_quiz2){
            answer += "츠";
            return R.drawable.stage6_answer2;
        }
        else if (id == R.id.stage6_quiz3) {
            answer += "막";
            return R.drawable.stage6_answer3;
        }
        else if (id == R.id.stage6_quiz4){
            answer += "추";
            return R.drawable.stage6_answer4;
        }
        else if (id == R.id.stage6_quiz5){
            answer += "수";
            return R.drawable.stage6_answer5;
        }
        else if (id == R.id.stage6_quiz6){
            answer += "굽";
            return R.drawable.stage6_answer6;
        }
        else return R.drawable.stage6_answer1;
    }
}
